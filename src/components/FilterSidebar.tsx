...
export const FilterSidebar: React.FC<FilterSidebarProps> = ({
  ...
  return (
    <>
      ...
      <div className={`
        fixed lg:relative top-0 right-0 h-full lg:h-auto w-80 lg:w-64 bg-white shadow-xl lg:shadow-none z-50
          ...
          <div className="mb-6">
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                min="1990"
                max={currentYear}
                className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-red-500 focus:border-border-transparent"
              />
            </div>
          </div>
        </div>
