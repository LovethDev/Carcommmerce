      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center bg-white rounded-xl shadow-lg p-6 transition duration-300 ease-in-out transform hover:-translate-y-2">
              <div className="bg-red-50 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 shadow-inner">
        ...
        {/* Call to Action */}
        <div className="bg-gradient-to-br from-red-600 to-red-800 rounded-2xl shadow-xl p-10 text-center text-white">
          ...
          <a
            href="/"
            className="inline-block bg-white text-red-600 px-8 py-3 rounded-lg font-semibold shadow-md hover:bg-gray-100 transition duration-300 ease-in-out transform hover:scale-105"
          >
            Browse Cars
          </a>
        </div>
